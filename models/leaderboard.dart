...
class Leaderboard {
	int? leaderboard_id;
	final String leaderboard_group;
	...
	Leaderboard({
		this.leaderboard_id,
		required this.leaderboard_group,
	...
	factory Leaderboard.fromMap(Map<String, dynamic> map) {
		return Leaderboard(
			...
			leaderboard_group: map['leaderboard_group'] ?? 'navigators',
	...
	@override
	String toString() {
		return '{"leaderboard_id": $leaderboard_id, "leaderboard_group": "$leaderboard_group", "leaderboard_year": $leaderboard_year, "leaderboard_week_number": $leaderboard_week_number, "leaderboard_created_at": "$leaderboard_created_at"}';
	}
}